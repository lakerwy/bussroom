    ...
    >
      <div class="main-header">
        ...
        <div class="header-middle-con">
          ...
          <div class="nav-search" style="margin-top: 5px; display: flex">
            <div>
              <Input v-model="navSearchVal" search placeholder="请输入搜索内容">
                <Select v-model="navSelectVal" slot="prepend" style="width: 100px;">
                  <Option value="day">标题+正文</Option>
                  <Option value="month">内容</Option>
                </Select>
              </Input>
            </div>
