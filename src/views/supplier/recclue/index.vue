  ...
  <div id="recclue">
    <Form :model="formItem" :label-width="80" class="form">
      ...
      <Form-item label="发布时间">
        <Date-picker :value="formItem.publishDate" type="daterange" placement="bottom-end" placeholder="选择日期" style="width: 200px"></Date-picker>
      </Form-item>
    ...
    <Tabs value="name1" class="rectabs">
      <Tab-pane label="在线报名信息" name="name1">
        <div class="clue-tip">
          ...
          <Button type="primary" class="tip-delete" @click="batchCliam()">批量认领</Button>
          </p>
        </div>
